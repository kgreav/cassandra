        ...
        try
        {
            ...
            while (sstableIterator.hasNext())
            {
                ...
                for (Range<Token> r : normalizedRanges)
                {
                    ...
                    else if (sstableRange.intersects(r) && !nonAnticompacting.contains(sstable))
                    {
                ...
                if (!anticompactRanges.isEmpty())
                    logger.info("[repair #{}] SSTable {} ({}) will be anticompacted on range {}", parentRepairSession, sstable, sstableRange, String.join(", ", anticompactRanges));
